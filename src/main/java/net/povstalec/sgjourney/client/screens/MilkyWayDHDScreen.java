...
{
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(StargateJourney.MODID, "textures/gui/dhd/milky_way/milky_way_dhd_background.png");
