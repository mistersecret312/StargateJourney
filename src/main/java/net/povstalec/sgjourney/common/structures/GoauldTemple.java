...
public class GoauldTemple extends Structure
{
    public static final MapCodec<GoauldTemple> CODEC = RecordCodecBuilder.<GoauldTemple>mapCodec(instance ->
            instance.group(GoauldTemple.settingsCodec(instance),
            ...
            ).apply(instance, GoauldTemple::new));
    ...
    public GoauldTemple(Structure.StructureSettings config,
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context)
    {
        ...
        if (!GoauldTemple.extraSpawningChecks(context))
        {
    ...
    {
        return StructureInit.GOAULD_TEMPLE.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}
