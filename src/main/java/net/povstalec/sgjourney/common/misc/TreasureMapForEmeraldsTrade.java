	...
	public MerchantOffer getOffer(Entity entity, RandomSource source)
	{
		if(entity.level() instanceof ServerLevel level)
		{
			...
			if(blockpos != null)
			{
				...
				return new MerchantOffer(new ItemCost(new ItemStack(Items.EMERALD).getItem(), this.emeraldCost), Optional.of(new ItemCost(new ItemStack(Items.COMPASS).getItem())), itemstack, this.maxUses, this.villagerXp, 0.2F);
			}
			else
				return null;
		}
