...
public class MenuInit 
{
	...
	public static final Supplier<MenuType<InterfaceMenu>> INTERFACE =
            registerMenuType(InterfaceMenu::new, "interface");
	
	public static final Supplier<MenuType<RingPanelMenu>> RING_PANEL =
            registerMenuType(RingPanelMenu::new, "ring_panel");
	
	public static final Supplier<MenuType<DHDCrystalMenu>> DHD_CRYSTAL =
            registerMenuType(DHDCrystalMenu::new, "dhd_crystal");
	
	public static final Supplier<MenuType<MilkyWayDHDMenu>> MILKY_WAY_DHD =
            registerMenuType(MilkyWayDHDMenu::new, "milky_way_dhd");
	
	public static final Supplier<MenuType<PegasusDHDMenu>> PEGASUS_DHD =
            registerMenuType(PegasusDHDMenu::new, "pegasus_dhd");
	
	public static final Supplier<MenuType<ClassicDHDMenu>> CLASSIC_DHD =
