...
{
	public static final DeferredRegister<FluidType> FLUID_TYPES = DeferredRegister.create(NeoForgeRegistries.FLUID_TYPES, StargateJourney.MODID);
	
	
	public static final Supplier<FluidType> LIQUID_NAQUADAH_FLUID_TYPE = FLUID_TYPES.register("liquid_naquadah", () ->
	...
	public static final Supplier<FluidType> HEAVY_LIQUID_NAQUADAH_FLUID_TYPE = FLUID_TYPES.register("heavy_liquid_naquadah", () -> 
