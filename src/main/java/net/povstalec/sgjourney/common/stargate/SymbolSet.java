...
public class SymbolSet
{
	...
	public static final ResourceLocation SYMBOL_SET_LOCATION = ResourceLocation.fromNamespaceAndPath(StargateJourney.MODID, "symbol_set");
	...
	{
		ResourceLocation texture = ResourceLocation.fromNamespaceAndPath(this.texture.getNamespace(), "textures/symbols/" + this.texture.getPath());
		return texture;
	}
	...
	public static SymbolSet getSymbolSet(Level level, String name)
	{
		...
		return registry.get(ResourceLocation.fromNamespaceAndPath(split[0], split[1]));
	}
