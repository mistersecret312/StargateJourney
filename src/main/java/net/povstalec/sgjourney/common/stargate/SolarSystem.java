...
{
	public static final ResourceKey<Registry<SolarSystem>> REGISTRY_KEY = ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath(StargateJourney.MODID, "solar_system"));
	...
	{
        return getSolarSystem(level, ResourceLocation.fromNamespaceAndPath(part1, part2));
	}
