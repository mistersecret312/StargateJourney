...
public class PointOfOrigin
{
	...
	public static final ResourceLocation POINT_OF_ORIGIN_LOCATION = ResourceLocation.fromNamespaceAndPath(StargateJourney.MODID, "point_of_origin");
	...
	public ResourceLocation texture()
	{
		...
		ResourceLocation texture = ResourceLocation.fromNamespaceAndPath(path.getNamespace(), "textures/symbols/" + path.getPath());
